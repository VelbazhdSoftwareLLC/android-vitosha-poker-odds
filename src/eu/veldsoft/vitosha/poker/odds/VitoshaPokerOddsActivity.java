...
public class VitoshaPokerOddsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
					...
					if (calculator != null) {
						displayrHandler.postDelayed(new Runnable() {
							public void run() {
								...
								((TextView) findViewById(R.id.chance))
										.setText("" + chance);
							}
						}, 0);
					}
		...
		spinner = (Spinner) findViewById(R.id.hand1);
		adapter = ArrayAdapter.createFromResource(this, R.array.cards_array,
				android.R.layout.simple_spinner_item);
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		spinner.setAdapter(adapter);
		spinner.setSelection(adapter.getPosition(settings.getString("hand1",
				getString(R.string.default_card_value))));
		...
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		spinner.setAdapter(adapter);
		spinner.setSelection(adapter.getPosition(settings.getString("hand2",
				getString(R.string.default_card_value))));
		...
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		spinner.setAdapter(adapter);
		spinner.setSelection(adapter.getPosition(settings.getString("flop1",
				getString(R.string.default_card_value))));
		...
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		spinner.setAdapter(adapter);
		spinner.setSelection(adapter.getPosition(settings.getString("flop2",
				getString(R.string.default_card_value))));
		...
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		spinner.setAdapter(adapter);
		spinner.setSelection(adapter.getPosition(settings.getString("flop3",
				getString(R.string.default_card_value))));
		...
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		spinner.setAdapter(adapter);
		spinner.setSelection(adapter.getPosition(settings.getString("turn",
				getString(R.string.default_card_value))));
		...
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		spinner.setAdapter(adapter);
		spinner.setSelection(adapter.getPosition(settings.getString("river",
				getString(R.string.default_card_value))));

		spinner = (Spinner) findViewById(R.id.iterations);
		adapter = ArrayAdapter.createFromResource(this,
				R.array.iterations_array, android.R.layout.simple_spinner_item);
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		spinner.setAdapter(adapter);
		spinner.setSelection(adapter.getPosition(settings.getString(
				"iterations", getString(R.string.default_iterations_value))));

		spinner = (Spinner) findViewById(R.id.players);
		adapter = ArrayAdapter.createFromResource(this,
				R.array.number_of_players_array,
				android.R.layout.simple_spinner_item);
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		spinner.setAdapter(adapter);
		spinner.setSelection(adapter.getPosition(settings.getString("players",
				getString(R.string.default_number_of_players_value))));
		...
		((Button) findViewById(R.id.clear))
				.setOnClickListener(new View.OnClickListener() {
					public void onClick(View view) {
						...
						((Spinner) findViewById(R.id.iterations))
								.setSelection(0);
		...
		((Button) findViewById(R.id.calculate))
				.setOnClickListener(new View.OnClickListener() {
					public void onClick(View view) {
						...
						String hand1 = ""
								+ ((Spinner) findViewById(R.id.hand1))
										.getSelectedItem();
						String hand2 = ""
								+ ((Spinner) findViewById(R.id.hand2))
										.getSelectedItem();
						String flop1 = ""
								+ ((Spinner) findViewById(R.id.flop1))
										.getSelectedItem();
						String flop2 = ""
								+ ((Spinner) findViewById(R.id.flop2))
										.getSelectedItem();
						String flop3 = ""
								+ ((Spinner) findViewById(R.id.flop3))
										.getSelectedItem();
						String turn = ""
								+ ((Spinner) findViewById(R.id.turn))
										.getSelectedItem();
						String river = ""
								+ ((Spinner) findViewById(R.id.river))
										.getSelectedItem();
						String players = ""
								+ ((Spinner) findViewById(R.id.players))
										.getSelectedItem();
						String iterations = ""
								+ ((Spinner) findViewById(R.id.iterations))
										.getSelectedItem();
						 ...
						 */
						if (hand1
								.equals(getString(R.string.default_card_value)) == true
								|| hand2.equals(getString(R.string.default_card_value)) == true) {
							Toast.makeText(getApplicationContext(),
									R.string.player_s_cards_needed_toast,
						...
						if ((flop1
								.equals(getString(R.string.default_card_value)) == true
								|| flop2.equals(getString(R.string.default_card_value)) == true || flop3
								.equals(getString(R.string.default_card_value)) == true)
								&& (flop1
										.equals(getString(R.string.default_card_value)) == false
										|| flop2.equals(getString(R.string.default_card_value)) == false || flop3
										.equals(getString(R.string.default_card_value)) == false)) {
							Toast.makeText(getApplicationContext(),
									R.string.flop_has_3_cards_toast,
									Toast.LENGTH_SHORT).show();
							return;
						}
						...
						if (turn.equals(getString(R.string.default_card_value)) == true
							...
							Toast.makeText(
									...
									R.string.do_not_miss_turn_before_river_toast,
									Toast.LENGTH_SHORT).show();
							return;
						}

						/*
						 * Player's card, flop, turn and river should be unique
						 * cards.
						 */
						String[] known = { hand1, hand2, flop1, flop2, flop3,
								turn, river };
						for (int i = 0; i < known.length; i++) {
							for (int j = i + 1; j < known.length; j++) {
								if (known[i]
									...
									Toast.makeText(getApplicationContext(),
											R.string.cards_are_not_unique_tast,
											Toast.LENGTH_SHORT).show();
									return;
								}
							}
						...
						String[] faces = getResources().getStringArray(
								R.array.cards_array);
						String[] codes = getResources().getStringArray(
								R.array.card_codes_array);
						String knownCards = "";

						/*
						 * Assemble known cards from interface and resource
						 * codes.
						 */
						for (int i = 0; i < known.length; i++) {
							if (known[i]
						...
						calculator = new MonteCarlo(knownCards, numberOfLoops,
								numberOfPlayers);
		...
		((Button) findViewById(R.id.bAbout))
				.setOnClickListener(new View.OnClickListener() {
					public void onClick(View view) {
