...
public class VitoshaPokerOddsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		spinner.setAdapter(adapter);
		spinner.setSelection(adapter.getPosition(settings.getString("iterations", getString(R.string.default_iterations_value))));

		spinner = (Spinner) findViewById(R.id.players);
		adapter = ArrayAdapter.createFromResource(this, R.array.number_of_players_array, android.R.layout.simple_spinner_item);
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		spinner.setAdapter(adapter);
		spinner.setSelection(adapter.getPosition(settings.getString("players", getString(R.string.default_number_of_players_value))));
		...
		((Button) findViewById(R.id.calculate)).setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				 ...
				 */
				if (hand1.equals(getString(R.string.default_card_value)) == true || hand2.equals(getString(R.string.default_card_value)) == true) {
					Toast.makeText(getApplicationContext(), R.string.player_s_cards_needed_toast, Toast.LENGTH_SHORT).show();
					return;
				}
				 ...
				 */
				if ((flop1.equals(getString(R.string.default_card_value)) == true || flop2.equals(getString(R.string.default_card_value)) == true || flop3.equals(getString(R.string.default_card_value)) == true) && (flop1.equals(getString(R.string.default_card_value)) == false || flop2.equals(getString(R.string.default_card_value)) == false || flop3.equals(getString(R.string.default_card_value)) == false)) {
				 ...
				 */
				if (turn.equals(getString(R.string.default_card_value)) == true && river.equals(getString(R.string.default_card_value)) == false) {
					Toast.makeText(getApplicationContext(), R.string.do_not_miss_turn_before_river_toast, Toast.LENGTH_SHORT).show();
					return;
				}
				...
				for (int i = 0; i < known.length; i++) {
					for (int j = i + 1; j < known.length; j++) {
						if (known[i].equals(getString(R.string.default_card_value)) == false && known[i].equals(known[j]) == true) {
							Toast.makeText(getApplicationContext(), R.string.cards_are_not_unique_tast, Toast.LENGTH_SHORT).show();
							return;
						}
					}
				}
